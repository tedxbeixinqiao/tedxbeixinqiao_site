        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mx-auto max-w-3xl text-lg leading-relaxed text-gray-800 dark:text-red-50">
              ...
              innovation, a shift in mindset, or a story that stirs something
              deep within us. Join a community passionate about ideas in motion
          ...
          <div className="mb-20 grid gap-16 md:grid-cols-2">
                ...
                {isVideoPlaying ? (
                  ...
                  >
                    <Image
                      ...
                      style={{
                        transform: `scale(${isHoveringImage ? 1.05 : 1})`,
                      }}
                    />
                    <motion.div
            ...
            >
              ...
              <p className="text-gray-700 dark:text-gray-300">
                TEDxBeixinqiao brings the spirit of TED to Beijing's vibrant
                cultural district. These independently organized events create a
                unique platform where innovation meets tradition.
              </p>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-red-200/70">
                      Paradigm shifts, breakthrough discoveries, and rethinking
                      old systems
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-red-200/70">
                      Migration, cultural shifts, physical journeys, and
                      community-building
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-red-200/70">
                      Talks that stir empathy, inspiration, and reflection
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-red-200/70">
                      Social impact, environmental change, and "doing" rather
                      than "saying"
                    </p>
                  </div>
                </motion.div>
              ...
              <div className="flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 p-3 text-red-800 dark:border-red-900/50 dark:bg-red-900/20 dark:text-red-400">
                ...
                <span className="text-sm font-medium">
                  Next event Dec 6th, 2025
                </span>
              </div>

              <Link
                href="/speakers"
                className="mt-4 group inline-flex items-center gap-1 text-red-600 dark:text-red-500 font-medium hover:text-red-700 dark:hover:text-red-400"
              >
                Meet our speakers
          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-gray-700 dark:text-red-200/70">
                Community Events
              </p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              >
                <path
                  d="M9.5 8.5H5.5C4.4 8.5 3.5 9.4 3.5 10.5V13.5C3.5 14.6 4.4 15.5 5.5 15.5H7.5C8.6 15.5 9.5 16.4 9.5 17.5V18.5C9.5 19.6 8.6 20.5 7.5 20.5H5.5C4.9 20.5 4.5 20.1 4.5 19.5C4.5 18.9 4.9 18.5 5.5 18.5H7.5V17.5H5.5C3.3 17.5 1.5 15.7 1.5 13.5V10.5C1.5 8.3 3.3 6.5 5.5 6.5H9.5C10.1 6.5 10.5 6.9 10.5 7.5C10.5 8.1 10.1 8.5 9.5 8.5Z"
                  fill="currentColor"
                />
                <path
                  d="M18.5 8.5H14.5C13.4 8.5 12.5 9.4 12.5 10.5V13.5C12.5 14.6 13.4 15.5 14.5 15.5H16.5C17.6 15.5 18.5 16.4 18.5 17.5V18.5C18.5 19.6 17.6 20.5 16.5 20.5H14.5C13.9 20.5 13.5 20.1 13.5 19.5C13.5 18.9 13.9 18.5 14.5 18.5H16.5V17.5H14.5C12.3 17.5 10.5 15.7 10.5 13.5V10.5C10.5 8.3 12.3 6.5 14.5 6.5H18.5C19.1 6.5 19.5 6.9 19.5 7.5C19.5 8.1 19.1 8.5 18.5 8.5Z"
                  fill="currentColor"
                />
              </motion.svg>
              <motion.p
                ...
                whileHover={{ scale: 1.01 }}
              >
                At TEDx, we believe in the power of ideas to change attitudes,
