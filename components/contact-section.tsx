        ...
        <div className="mx-auto max-w-6xl">
          <motion.div variants={itemVariants} className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-3xl text-lg text-gray-700 dark:text-gray-300">
              Have questions about our upcoming events or interested in partnership opportunities? Reach out to our team, and we'll be happy to assist you.
            </p>
          </motion.div>

          <motion.div variants={itemVariants} className="mx-auto grid gap-8 md:grid-cols-2">
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="mb-1 text-lg font-semibold text-black dark:text-white">Email</h3>
                  <p className="text-gray-700 dark:text-gray-300">Info@tedxbeixinqiao.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="mb-1 text-lg font-semibold text-black dark:text-white">Address</h3>
                  <p className="text-gray-700 dark:text-gray-300">Beixinqiao subdistrict, Dongcheng, Beijing</p>
                </div>
              </div>
            </div>
            ...
            >
              <h3 className="mb-4 text-xl font-semibold text-black dark:text-white">Send us a message</h3>
